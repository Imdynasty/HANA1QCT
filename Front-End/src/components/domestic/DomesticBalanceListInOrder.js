...
import "../../css/DomesticBalanceListInOrder.css"; // CSS 파일을 분리하여 관리
...
const DomesticBalanceList = ({ accountId }) => {
  ...
  return (
    <div className="horizontal-scroll-container">
      {balances.map((item) => {
        return (
          <div className="horizontal-list-item hover-effect" key={item.pdno}>
            <Skeleton
              paragraph={{ rows: 2 }}
              avatar
              title={true}
                ...
                <div
                  ...
                  <div style={{ display: "flex" }}>
                    ...
                    <span className="hover-effectnum">
                      {Number(item.hldgQty).toLocaleString()}주
                    </span>
                  </div>
                </div>
