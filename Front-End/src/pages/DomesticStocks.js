...
import SearchStock from "../components/domestic/SearchStock";
import DomesticContract from "../components/domestic/DomesticContract";
import "../css/DomesticStocks.css";
import DomesticTradingViewChart from "../components/domestic/DomesticTradingViewChart";
import DomesticOrder from "../components/domestic/DomesticOrder";
import StockAnalysis from "../components/domestic/StockAnalysis";
  ...
  const handleSummaryImageClick = async () => {
    try {
      const response = await fetch(
        "http://54.180.14.45:5000/update_contracts",
        {
          method: "POST",
        }
      );
      ...
      toast.error("Error occurred while updating contracts.");
    }
  };
      ...
      <div style={{ display: "flex", flexDirection: "column" }}>
        <div
          ...
          <div
            ...
            <DomesticOrder selectedStock={selectedStock} />
          </div>
        </div>
        <div
